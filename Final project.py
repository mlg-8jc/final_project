...
# MAGIC the dimensional data mart extracts data from a public reddit API(https://dashboard.nbshare.io/apps/options/top-etf-options-by-open-interest/) and kaggle datasets, which is then transformed and loaded into connected databases. The following data is read in from a local file.
...
# MAGIC %md
# MAGIC Making dimension table 1 for exchanges by type of investment, date, by etf key and by buyer sentiment. 
...
# MAGIC %md
# MAGIC visualizations in separate file
